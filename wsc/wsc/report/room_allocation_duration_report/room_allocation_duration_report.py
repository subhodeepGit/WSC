...
def get_data(filters):
    ...
    # time_diff = datetime.strptime(filters['to_date'] , '%Y-%m-%d') - datetime.strptime(filters['from_date'] , '%Y-%m-%d')

    total_time = (datetime.strptime(filters['to_date'] , '%Y-%m-%d') - datetime.strptime(filters['from_date'] , '%Y-%m-%d')).total_seconds()/3600
