...
from wsc.wsc.notification.custom_notification import send_mail_to_hr_updation,send_mail_to_reporting,attendance_update_mail,attendance_update_mail_employee
...
def approver_mail(doc):
	...
	if reporting_auth_id:
		...
		data["from_date"]=doc.from_date
		data["to_date"]=doc.to_date
...
def validate(doc,method):
	...
	if doc.workflow_state=="Approved":
		attendance_update_mail(data)
		attendance_update_mail_employee(data)	
